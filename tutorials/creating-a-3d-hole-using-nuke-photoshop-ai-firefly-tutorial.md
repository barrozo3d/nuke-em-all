...
- Blender + Nuke | A.I Enhanced Digital Matte Painting Workflow (`blender-nuke-ai-enhanced-digital-matte-painting-workflow.md`) — shares the "generate/enhance 2D detail with AI, then re-project onto real geometry in Nuke via Project3D" core technique, using Krea AI/Magnific AI instead of Firefly.
