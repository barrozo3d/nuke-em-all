...
- A new way to design VFX | Virtual Reality | Gravity Sketch + Nuke Tutorial (`a-new-way-to-design-vfx-virtual-reality-gravity-sketch-nuke-tutorial.md`) — shares the same "design 2D textures in Nuke, hand-build custom 3D geometry in another tool (VR here, Blender there), bring it back into Nuke" pipeline shape, plus the `PolarDistort` gizmo.
