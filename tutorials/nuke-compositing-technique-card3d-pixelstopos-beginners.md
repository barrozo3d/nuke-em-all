...
- [UV / ST Maps [Part 2] | Nuke Compositing [Beginner / Intermediate]](uv-st-maps-part-2-nuke-compositing-beginner-intermediate.md) — shares the goal of making a 2D element stick to a moving 3D scene without a live per-frame projection setup, via a precomped UV-projection instead of Card3D-distance anchoring.
