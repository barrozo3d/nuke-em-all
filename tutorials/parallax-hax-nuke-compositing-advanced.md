...
- [UV / ST Maps [Part 2] | Nuke Compositing [Beginner / Intermediate]](uv-st-maps-part-2-nuke-compositing-beginner-intermediate.md) — this is the specific "last video about UV and blending morphs" this tutorial explicitly references as the source of its UV-coordinate-system prerequisite.
