...
- UV / ST Maps [Part 2] | Nuke Compositing [Beginner / Intermediate] (`uv-st-maps-part-2-nuke-compositing-beginner-intermediate.md`) — shares `3d-system`, `st-map`; that video's 32-bit-float/no-compression precomp-quality requirement for its UV projection pass echoes this tutorial's core quality-preservation lesson.
