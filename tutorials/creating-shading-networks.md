...
- [Loading USD Plug-ins into Katana](loading-usd-plug-ins-into-katana.md) — shares `katana` + `katana-9`; the terminal sidebar documented here gains a `usd` menu once the USD plug-ins are loaded.
