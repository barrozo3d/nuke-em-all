...
- Compositing in UV space with Projections | Nuke [Advanced] (`compositing-in-uv-space-with-projections-nuke-advanced.md`) — shares `3d-system`, `advanced`; both build convincing dynamic lighting/reflectivity on top of otherwise-static projected footage using NukeX's 3D toolset.
