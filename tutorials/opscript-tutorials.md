...
*Note: the library held zero Katana sources before 2026-08-24 (see `KNOWLEDGE_GAPS_TODO.md`) and now holds seven, so the Katana cross-link set is still narrow.*
