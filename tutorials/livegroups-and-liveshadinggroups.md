...
- [Creating Shading Networks](creating-shading-networks.md) — shares `katana` + `nodegraph`; a finished NetworkMaterialCreate network is exactly the kind of self-contained node group a LiveGroup publishes and reloads across projects.
