...
- [Blender + Nuke | A.I Enhanced Digital Matte Painting Workflow](blender-nuke-ai-enhanced-digital-matte-painting-workflow.md) — shares the Blender-to-Nuke cross-app pipeline pattern (camera/geometry export via Alembic) used to bring a projection setup from Blender into Nuke.
