...
them. **This library already holds 31 entries whose own Structured Notes discuss
...
|---|---|---|
| Blender — geometry nodes, Cycles/EEVEE, motion design | `blender-motion` | 21 |
| Houdini — SOPs, DOPs, VEX, LOPs/Solaris, Karma, KineFX | `houdini-wand` | 5 |
| Substance 3D Painter — texturing, smart materials, baking | `paint-me-like-your-french-substances` | 3 |
| Unreal — Sequencer, Niagara, Lumen/Nanite, Movie Render Queue | `unreal-sidekick` | 2 |
...
3. **Fill in ALL Structured Notes** (replace every `[PENDING EXTRACTION]`):
   ...
   - **Key Steps** — **as many steps as the tutorial actually contains**, in order,
     with exact node/tool names. Not a highlight reel: if the
