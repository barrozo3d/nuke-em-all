"""
ingest.py — Data collection for nuke-em-all skill (Step 1 of 2)
...
WHISPER_VOCAB_HINT = ("Nuke, NukeX, Foundry, Nuke Studio, Hiero, Mari, Katana, roto, rotopaint, "
                      "keyer, keylight, IBK, despill, merge, grade, colorcorrect, defocus, vectorblur, "
                      "tracker, camera tracker, deep compositing, Cryptomatte, ST map, UDIM, USD, "
                      "scenegraph, look dev, lookdev, CopyCat, gizmo, EXR, AOV, scanline render, "
                      "3D system, particles, expression, TCL, PySide")
...
def whisper_transcribe(audio_path, model_name):
    ...
    # Whisper mis-hears domain terms (e.g. "Katana" -> "Cadana", "Cryptomatte" -> "crypto mat").
...
def main():
    parser = argparse.ArgumentParser(description="Nuke/Foundry-suite tutorial data collection (Step 1 of 2)")
