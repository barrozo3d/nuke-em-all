#!/usr/bin/env python3
"""
validate.py -- Post-ingest integrity checker for nuke-em-all tutorials.
...
# The four skills (blender-motion / houdini-wand / unreal-sidekick / nuke-em-all)
# deliberately carry copies of the same ingest pipeline. Copies have historically
# drifted (missing UTF-8 fix, mismatched cookies flags), so when sibling skill dirs
# are present on this machine, compare the shared helper functions and WARN on
