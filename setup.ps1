# =============================================================================
# nuke-em-all skill — Setup Script (Windows)
# =============================================================================
...
# Nuke MCP connection (see SETUP.md → "Nuke MCP Connection") is a separate,
# manual setup that runs inside Nuke itself — not part of this script.
# =============================================================================
...
Write-Host "  nuke-em-all skill - Setup" -ForegroundColor Magenta
Write-Host "======================================================" -ForegroundColor Magenta
...
if ($allOK) {
    ...
    Write-Host "  (Optional) For a live Nuke connection, see SETUP.md ->" -ForegroundColor Green
    Write-Host "  'Nuke MCP Connection' — separate, manual, requires Nuke installed." -ForegroundColor Green
    Write-Host "======================================================" -ForegroundColor Green
} else {
